                  ...
                  <div className="card-body">
                    ...
                    <div className="datatable-wrapper datatable-loading nofooter sortable searchable fixed-columns">
                      <div className="datatable-top">
                        ...
                        <div className="datatable-search">
                          ...
                          />
                          <button className="btn btn-primary approveBtn" type="button"   data-bs-formtarget="#basicModal" onClick={handleToggle} id="approveBtn">+ 구매신청</button>
                        </div>
                      </div>
                    </div>
                    <table className="table datatable">
                      ...
                      {AssetRequest.slice(
                          ...
                          <AssetAllListTable key={index} {...i} index={index} func={handleToggle}/>
                      ))}
                      </tbody>
                    </table>
                  </div>
